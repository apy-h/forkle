  ...
  return (
    <div className="app">
      ...
      <div className="rules-form">
        <label>Winning Score: <input type="number" min="1" value={farkle.winningScore} onChange={e => farkle.setWinningScore(+e.target.value)} /></label>
        <label>Min Score to Bank on First Turn: <input type="number" min="0" max={farkle.winningScore} value={farkle.minBankScore} onChange={e => farkle.setMinBankScore(+e.target.value)} /></label>
        ...
        <label>Four of a kind and a pair: <input type="number" min="0" max={farkle.winningScore} value={farkle.rules.fourOfAKindAndPair} onChange={e => farkle.setRules({...farkle.rules, fourOfAKindAndPair: +e.target.value})} /></label>
      ...
      <button onClick={farkle.resetToDefaults}>Reset to Defaults</button>
    </div>
  )
}
